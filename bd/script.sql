...
produtora varchar(20) not null unique,
...
insert into generos (genero) values('Plataforma');
insert into generos (genero) values('Estratégia');
insert into generos (genero) values('RPG');
insert into generos (genero) values('Esporte');
insert into generos (genero) values('Corrida');
insert into generos (genero) values('Tabuleiro');
insert into generos (genero) values('Puzzle');
insert into generos (genero) values('Luta');
...
select * from jogos where cod=6;

alter table generos modify cod int(11) auto_increment primary key;
*/
